                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <p className="mt-3"><MailOutlineIcon />Address: <span>{getuserdata.add}</span></p>
                            <p className="mt-3"><WorkIcon />City: <span>{getuserdata.city}</span></p>
                        </div>
                        <div className="right_view  col-lg-6 col-md-6 col-12">

                            <p className="mt-5"><PhoneAndroidIcon />Sate: <span>+91 {getuserdata.state}</span></p>
                            <p className="mt-3"><LocationOnIcon />Contact: <span>{getuserdata.mobile}</span></p>
                            <p className="mt-3">Image: <span>{getuserdata.img}</span></p>
                        </div>
                    </div>
